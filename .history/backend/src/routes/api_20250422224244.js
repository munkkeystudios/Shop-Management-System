...
// User Management
router.get('/users', isAdmin, userController.getAllUsers); // Only Admin sees all users
router.post('/users', isAdmin, userController.adminCreateUser); // Only Admin creates users
router.put('/users/:userId', isAdmin, userController.updateUser); // Only Admin updates any user (role, password reset etc.)
router.delete('/users/:userId', isAdmin, userController.deleteUser); // Only Admin deletes users
router.get('/users/export', isAdmin, userController.exportUsers); // Only Admin exports users
